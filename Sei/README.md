Copy from https://github.com/kj89/testnet_manuals/blob/main/sei/README.md
<p align="center">
...
```
wget -O sei_testnet.sh https://raw.githubusercontent.com/Archideus/nodes_scripts/main/Sei/sei.sh && chmod +x sei_testnet.sh && ./sei_testnet.sh
```
